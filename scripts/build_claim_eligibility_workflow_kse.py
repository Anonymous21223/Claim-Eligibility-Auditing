...
def build() -> None:
    ...
    ax.plot([0.18, 0.90], [0.579, 0.579], color=LINE, linewidth=0.85, zorder=1)
    arrow(
        ax,
        (0.87, 0.653),
        (0.90, 0.579),
    ...
    fig.savefig(
        ...
        pad_inches=0.025,
        facecolor=WHITE,
        metadata={"Software": "Claim Eligibility Artifact"},
